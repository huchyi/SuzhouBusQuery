...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.pagertab_item_bg_selector;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        ColorStateList tmpTabTextColor = a.getColorStateList(1);
        if (tmpTabTextColor != null) {
            tabTextColor = tmpTabTextColor;
        }
    ...
    private void addRedPointTextTab(final int position, String title) {
        View inflate = LayoutInflater.from(getContext()).inflate(R.layout.pagertab_redpoint_item_view, null);
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            TextView tab = (TextView) v.findViewById(R.id.tv);
            if (tab != null) {
